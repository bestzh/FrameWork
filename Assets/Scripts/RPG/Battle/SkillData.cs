...
/// <summary>
/// 技能数据 - ScriptableObject资源
/// </summary>
[CreateAssetMenu(fileName = "SkillData", menuName = "RPG/Skill/Create New Skill Data")]
public class SkillData : ScriptableObject
{
    ...
    [Header("伤害设置")]
    public int Damage = 20;                // 技能伤害
    public float DamageMultiplier = 1.0f;  // 伤害倍数（基于角色属性）
}
